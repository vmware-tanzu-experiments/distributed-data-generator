...
public class ByteSerializeHandler implements XMLObjectSerializeHandler<Byte>
{
    private int radix;
    private AttributesImpl attrs;
    public ByteSerializeHandler()
    {
        radix = 10;
        attrs = new AttributesImpl();
    }
    
    public ByteSerializeHandler(int radix)
    {
        this.radix = radix;
        attrs = new AttributesImpl();
    ...
    throws SAXException, AbortedException
    {
        ...
        char [] outputChars = Integer.toString(objectToSerialize.byteValue(), radix).toCharArray();
