...
public class BurnDeviceEventAdapter implements EventHandler
{
    private BurnDeviceEventListener listener;
    public BurnDeviceEventAdapter(BurnDeviceEventListener listener)
    {
